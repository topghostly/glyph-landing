  ...
  return (
    <section className="relative overflow-x-hidden">
      <div className="top-[160px] w-full absolute max-w-[1280px] translate-x-[-50%] left-[50%] pb-[80px] z-10">
        ...
        <div className="mt-[400px] absolute bottom-0">
      ...
      <div className="relative h-full w-[1920px] left-[50%] aspect-[1.335187] translate-x-[-50%] top-0">
        <video
          ...
          style={{ opacity: 1 }}
        >
          <source src="/videos/0512.mp4" type="video/mp4" />
          {/* <source src="#" type="video/webm" /> */}
        </video>
      </div>
    </section>
    // <section className="pt-[160px] relative aspect-[1.9] ">
    ...
    //   {/* <----------VIDEO BACKGROUND----------> */}
    //   <div className="absolute w-full h-full max-w-[1920px] left-[50%] translate-x-[-50%] bg-amber-600 top-0 opacity-10">
    //     <video
    //       className="absolute inset-0 w-full h-full"
    //       width="1920"
    //       height="1438"

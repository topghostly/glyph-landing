    ...
    >
      <style>{`
        .loader-path-1 {
          ...
          animation: strokeAnim1 8s ease-in-out forwards, fillAnim1 5s ease-in-out forwards;
          fill-opacity: 0;
        }
        ...
        .loader-path-2 {
          ...
          animation: strokeAnim2 8s ease-in-out forwards, fillAnim2 5s ease-in-out forwards;
          fill-opacity: 0;
        }
